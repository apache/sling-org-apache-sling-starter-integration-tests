...
public class JsonRenderingTest extends HttpTestBase {
    ...
    /** Logger instance */
    private static final Logger log = LoggerFactory.getLogger(JsonRenderingTest.class);
    ...
    protected void setUp() throws Exception {
        ...
        // allow collisions
        postUrl =
                HTTP_BASE_URL + testPath + "_" + System.currentTimeMillis() + SlingPostConstants.DEFAULT_CREATE_SUFFIX;
    ...
    public void testRecursiveInfinityTooDeep() throws IOException {
        ...
        // We skip http://localhost:8080/org.apache.sling.starter.testing-6-SNAPSHOT/
        // or http://localhost:8080/
        String resourceUrl = url;
        final int toSkip = resourceUrl.contains("/org.apache.sling.starter") ? 4 : 3;
    ...
    public void testAccentedStrings() throws IOException {
        ...
        final String location = testClient.createNode(postUrl, props, null, true);
        final String json = getContent(location + ".json", CONTENT_TYPE_JSON);
    ...
    public void testTidyNonRecursive() throws IOException {
        ...
        assertTrue(
                "The .tidy selector should add at least 2 EOL chars to json output (delta=" + delta + ")", delta > min);
    }
    ...
    public void testTidyRecursive() throws IOException {
        ...
        assertTrue(
                "The .tidy selector should add at least 5 EOL chars to json output (delta=" + delta + ")", delta > min);
    }
    ...
    public void testHarrayWithAndWithoutTidy() throws IOException {
        ...
        final int withTidy =
                countOccurences(getContent(HTTP_BASE_URL + "/.harray.tidy.1.json", CONTENT_TYPE_JSON), '\n');
