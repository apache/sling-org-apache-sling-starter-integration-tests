 ...
 * under the License.
 */
package org.apache.sling.starter.webapp.integrationtest.scripting.htl;
...
public class HtlTest extends HttpTestBase {
    ...
    public void testScriptWithJavaUseBean() throws IOException {
        ...
        testClient.upload(
                HTTP_BASE_URL + "/apps/sling/test/htl/java/java.html",
                getClass().getResourceAsStream("/integration-test/htl/java.html"));
        testClient.upload(
                HTTP_BASE_URL + "/apps/sling/test/htl/java/Bean.java",
                getClass().getResourceAsStream("/integration-test/htl/Bean.java"));

        testClient.createNode(
                HTTP_BASE_URL + "/content/htl/java-use-bean",
                Collections.singletonMap("sling:resourceType", "sling/test/htl/java"));

        String content =
                getContent(HTTP_BASE_URL + "/content/htl/java-use-bean.html", CONTENT_TYPE_DONTCARE, null, 200);
    ...
    public void testScriptWithModelUseBean() throws IOException {
        ...
        testClient.upload(
                HTTP_BASE_URL + "/apps/sling/test/htl/model/model.html",
        ...
        String content =
                getContent(HTTP_BASE_URL + "/content/htl/model-use-bean.html", CONTENT_TYPE_DONTCARE, null, 200);
