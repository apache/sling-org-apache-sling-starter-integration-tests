 ...
 * under the License.
 */
package org.apache.sling.starter.webapp.integrationtest.login;
...
public class RedirectOnLogoutTest {
    ...
    public void testRedirectToResourceAfterLogout() throws Exception {
        ...
        H.assertPostStatus(
                HttpTest.HTTP_BASE_URL + "/j_security_check", HttpServletResponse.SC_MOVED_TEMPORARILY, params, null);
