...
public class JspScriptingTest {
    ...
    public void setUp() throws Exception {
        ...
        final String testRootPath =
                HttpTest.HTTP_BASE_URL + "/" + getClass().getSimpleName() + "/" + System.currentTimeMillis();
    ...
    public void testUnstructuredNoScript() throws Exception {
        ...
        assertTrue(content.contains("PlainTextRenderer"));
        assertTrue(
                "Content contains " + unstructuredNode.testText + " (" + content + ")",
                content.contains(unstructuredNode.testText));
    }
    ...
    public void testTagFile() throws Exception {
        ...
        try {
            ...
            assertTrue(
                    "JSP script executed as expected (" + content + ")",
                    content.contains("<h1>Hello, Sling User</h1>"));
                ...
                final Condition c = new Condition() {
                    ...
                    public boolean isTrue() throws Exception {
                        final String content =
                                H.getContent(unstructuredNode.nodeUrl + ".html", HttpTest.CONTENT_TYPE_HTML);
    ...
    private void checkContent(final HttpTestNode tn) throws Exception {
        ...
        assertTrue(
                "JSP script executed as expected (" + content + ")", content.contains("<h1>JSP rendering result</h1>"));

        final String[] expected = {
            "using resource.adaptTo:" + tn.testText, "using currentNode:" + tn.testText,
        };
