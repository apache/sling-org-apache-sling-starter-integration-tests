 ...
 * under the License.
 */
package org.apache.sling.starter.webapp.integrationtest.resourceresolver;
...
import org.apache.sling.starter.testservices.exported.FakeSlingHttpServletRequest;
...
public class ResourceResolverApiTest {
    ...
    public void testRelativePathsA() {
        ...
        Assert.assertTrue(
                "Resource must be NonExistingResource: " + res01.getClass().getName(),
