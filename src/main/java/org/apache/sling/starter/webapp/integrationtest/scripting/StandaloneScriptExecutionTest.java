 ...
 * under the License.
 */
package org.apache.sling.starter.webapp.integrationtest.scripting;
...
public class StandaloneScriptExecutionTest extends HttpTestBase {
    ...
    public void testScriptExecution() throws Exception {
...

        {
            ...
            assertTrue(
                    "Expecting script URL to return raw script contents (" + content + ")",
...

        {
            ...
            assertTrue(
                    "Expecting execution URL to return " + expect + " (returns '" + content + "')",
