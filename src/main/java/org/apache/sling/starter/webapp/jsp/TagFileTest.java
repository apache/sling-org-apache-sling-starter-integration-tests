 ...
 * under the License.
 */
package org.apache.sling.starter.webapp.jsp;
...
public class TagFileTest {
    ...
    private void assertTaglibInstalled() throws IOException {
        final String content =
                H.getContent(H.HTTP_BASE_URL + "/system/console/status-jsptaglibs", H.CONTENT_TYPE_DONTCARE);
    ...
    public void testTagFileDeployedInBundle() throws IOException {
        ...
        H.getTestClient()
                .createNode(
                        H.HTTP_BASE_URL + "/content/tagtest",
        ...
        H.getTestClient()
                .upload(
                        H.HTTP_BASE_URL + "/apps/sling/test/tagfile/html.jsp",
